...
def preprocess_data(
    ...
    tokenizer: PreTrainedTokenizer):
    language_data_folder = path_utils.combine_path(semeval_path, 'corpora', language)
    corpus_path = path_utils.combine_path(language_data_folder, f'corpus{corpus_id}')
    ids = generate_transformer_tokens(corpus_path, tokenizer)
...
if __name__ == '__main__':
    ...
    tokenizer = XLNetTokenizer.from_pretrained('bert-base-cased')
